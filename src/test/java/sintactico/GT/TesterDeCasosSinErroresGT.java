...
public class TesterDeCasosSinErroresGT {

    private static final String msgExito = "[SinErrores]";
    private static final String testFilesDirectoryPath = "resources/sintactico/GiulianoTaormina/sinErrores/";
    ...
    public TesterDeCasosSinErroresGT(String input) {
        this.input = input;
    }
