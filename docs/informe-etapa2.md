...
| ***<Miembro\>***                         | `<Visibilidad> <MiembroSinVisibilidad>`                                                                                                                                                                                                                                           |
| ***<Visibilidad\>***                     | `public` \| `private` \| `ϵ`                                                                                                                                                                                                                                                      |
| ***<MiembroSinVisibilidad\>***           | `<AtributoOMetodo>` \|`<AtributoOMetodoOConstructor>` \| `<MetodoStatic>` \| `<MetodoVoid>`                                                                                                                                                                                       |
| ***<AtributoOMetodo\>***                 | ` prBoolean <DimensionesOpcionales> idMetVar <RestoAtributoOMetodo>` \| ` prChar <DimensionesOpcionales> idMetVar <RestoAtributoOMetodo>` \| ` prInt <DimensionesOpcionales> idMetVar <RestoAtributoOMetodo>` \| ` idGen <DimensionesOpcionales> idMetVar <RestoAtributoOMetodo>` |
| ***<AtributoOMetodoOConstructor\>***     | `idClase <RestoAtrMetCon>`                                                                                                                                                                                                                                                        |
| ***<RestoAtrMetCon\>***                  | `<TipoGenericoOpcional> <DimensionesOpcionales> idMetVar <RestoAtributoOMetodo>` \| `<Constructor>`                                                                                                                                                                               |
...
| ***<RestoNew\>***                        | `<TipoPrimitivo> <Dimensiones> ` \| `idGen <Dimensiones> ` \| `<TipoReferencia> <RestoTipoReferencia>`                                                                                                                                                                            |
| ***<RestoTipoReferencia\>***             | `<Dimensiones> ` \| `<ArgsActuales>`                                                                                                                                                                                                                                              |
...
| ***<RestoDimensiones\>***                | `<DimensionesConTamanio>` \| `<DimensionesSinTamanio> <InicializadorArreglo>`                                                                                                                                                                                                     |
...
| ***<InicializadorArreglo\>***            | `{ <IniArregloExpresiones> }`                                                                                                                                                                                                                                                     |
