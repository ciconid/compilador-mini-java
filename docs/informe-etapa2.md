...
| ***<AtributoOMetodo\>***                 | ` prBoolean idMetVar <RestoAtributoOMetodo>` \| ` prChar idMetVar <RestoAtributoOMetodo>` \| ` prInt idMetVar <RestoAtributoOMetodo>` \| ` idGen idMetVar <RestoAtributoOMetodo>` |
| ***<AtributoOMetodoOConstructor\>***     | `idClase <RestoAtrMetCon>`                                                                                                                                                        |
| ***<RestoAtrMetCon\>***                  | `idMetVar <RestoAtributoOMetodo>` \| `<Constructor>`                                                                                                                              |
